...
class Graph implements Iterable<Vertex> {
	...
	static TreeSet<Integer> setOfEdgeWeights;
    public LinkedList<Vertex> topological;
	/**
	 ...
	 */
	Graph(int size) {
		topological=new LinkedList<Vertex>();
		setOfEdgeWeights = new TreeSet<Integer>();
		numNodes = size;
